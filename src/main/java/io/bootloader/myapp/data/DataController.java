...
public class DataController {
	...
	public dataModel get_data_id(@PathVariable String id) {
		return data_service.get_data_id(id);
	}

	@RequestMapping(method=RequestMethod.POST, value="/data")
	public void post_data(@RequestBody dataModel data) {
		data_service.add_data(data);
	}

	@RequestMapping(method=RequestMethod.PUT, value="/data/{id}")
	public void post_data(@RequestBody dataModel data, @PathVariable String id) {
